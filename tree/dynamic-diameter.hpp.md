...
data:
  ...
  bundledCode: "#line 2 \"tree/dynamic-diameter.hpp\"\n\n#include <algorithm>\n#include\
    ...
    */\n\n/**\n * @brief Static Top Tree\n */\n#line 12 \"tree/dynamic-diameter.hpp\"\
  ...
  code: "#pragma once\n\n#include <algorithm>\n#include <cassert>\n#include <map>\n\
    ...
    \  r.d1 = a.d1;\n    r.d2 = max(a.d2, b.d1);\n  } else {\n    r.d1 = b.d1;\n \
    \   r.d2 = max(b.d2, a.d1);\n  }\n  return r;\n}\n\ntemplate <typename T>\nL<T>\
    \ add_edge(const H<T>& a) {\n  L<T> r;\n  r.dia = a.dia;\n  r.d1 = a.pd;\n  r.d2\
    \ = {0, -1};\n  return r;\n}\n\ntemplate <typename T>\nH<T> add_vertex(const L<T>&\
    \ a, T x, int i) {\n  H<T> r;\n  r.dia = max(a.dia, {a.d1.d + x + a.d2.d, a.d1.u,\
    \ a.d2.u});\n  r.pd = r.cd = {a.d1.d + x, a.d1.u};\n  r.p_to_c = x;\n  r.p = r.c\
    \ = i;\n  return r;\n}\n\ntemplate <typename T>\nstruct Aux_Tree {\n  int N, _buf;\n\
    \  const WeightedGraph<T>& g;\n  vector<vector<int>> aux;\n  vector<T> w;\n  map<pair<int,\
