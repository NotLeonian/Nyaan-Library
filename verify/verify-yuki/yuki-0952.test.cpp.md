...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-0952.test.cpp\"\n#define PROBLEM\
    ...
    \n//\n#line 2 \"dp/monge-d-edge-shortest-path-enumerate.hpp\"\n\n#line 6 \"dp/monge-d-edge-shortest-path-enumerate.hpp\"\
    ...
    \n//\n#line 2 \"dp/monge-d-edge-shortest-path.hpp\"\n\n#line 6 \"dp/monge-d-edge-shortest-path.hpp\"\
    \n\n#line 2 \"dp/golden-section-search.hpp\"\n\n#line 7 \"dp/golden-section-search.hpp\"\
    ...
    \n\n#line 6 \"dp/monge-shortest-path.hpp\"\nusing namespace std;\n\n// https://noshi91.hatenablog.com/entry/2023/02/18/005856\n\
    ...
    \ j) -> ll {\n    assert(i < j);\n    if (i + 1 == j) return 0;\n    return (r[j\
    \ - 1] - r[i]) * (r[j - 1] - r[i]);\n  };\n  auto ans = enumerate_monge_d_edge_shortest_path(N\
