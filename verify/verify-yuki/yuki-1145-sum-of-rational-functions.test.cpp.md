...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-1145-sum-of-rational-functions.test.cpp\"\
    ...
    \ 4 \"verify/verify-yuki/yuki-1145-sum-of-rational-functions.test.cpp\"\n//\n\
    ...
    \  auto ret = static_cast<NTT<mint>*>(FormalPowerSeries<mint>::ntt_ptr)->multiply(f,\
    ...
    \ min((int)f.size(), 2 * d); j++) F[j] = f[j];\n    for (int j = 0; j < d; j++)\
    \ g[j] = res[j];\n    F.ntt();\n    g.ntt();\n    for (int j = 0; j < 2 * d; j++)\
    \ F[j] *= g[j];\n    F.intt();\n    for (int j = 0; j < d; j++) F[j] = 0;\n  \
    \  F.ntt();\n    for (int j = 0; j < 2 * d; j++) F[j] *= g[j];\n    F.intt();\n\
    \    for (int j = d; j < min(2 * d, deg); j++) res[j] = -F[j];\n  }\n  return\
    \ res.pre(deg);\n}\n\ntemplate <typename mint>\nFormalPowerSeries<mint> fps_exp_impl(const\
    \ FormalPowerSeries<mint>& f, int deg,\n                                     FPSBackendPriority<1>)\
    ...
    \u30A4\u30D6\u30E9\u30EA\n */\n#line 3 \"fps/sum-of-rational-functions.hpp\"\n\
    ...
    \ 0 ? 1 : C(n + r - 1, r);\n  }\n};\n#line 10 \"verify/verify-yuki/yuki-1145-sum-of-rational-functions.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: verify/verify-yuki/yuki-1145-sum-of-rational-functions.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-1145-sum-of-rational-functions.test.cpp
- /verify/verify/verify-yuki/yuki-1145-sum-of-rational-functions.test.cpp.html
