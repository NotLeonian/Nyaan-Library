...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-1789.test.cpp\"\n#define PROBLEM\
    ...
    \ = sub(h, hr);\n\n  auto calc = [&](auto rc, int cg, int ch, bool ke = false)\
    \ -> ll {\n    pair<Hash, Hash> pa;\n    if (!ke) {\n      if (subg[cg] > subh[ch])\
  ...
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1789\"\n//\n#include \"\
    ...
    \ Hash = typename RootedTreeHash<vvi>::Hash;\n\nvi sub(vvi g, int r) {\n  int\
