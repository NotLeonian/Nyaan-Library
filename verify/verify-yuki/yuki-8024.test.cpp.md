...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/8024
    links:
    - https://yukicoder.me/problems/no/8024
  bundledCode: "#line 1 \"verify/verify-yuki/yuki-8024.test.cpp\"\n#define PROBLEM\
    ...
    \ 4 \"verify/verify-yuki/yuki-8024.test.cpp\"\n//\n#line 2 \"math/rational.hpp\"\
    ...
    \ | b) res.push_back(i);\n  return res;\n}\n\n/**\n * @brief \u4E0B\u4F4D\u96C6\
    \u5408/\u4E0A\u4F4D\u96C6\u5408\u306E\u5217\u6319\n */\n#line 7 \"verify/verify-yuki/yuki-8024.test.cpp\"\
    ...
    \ mkuni(dp[i]);\n  }\n  out(\"NO\");\n}\n\nvoid Nyaan::solve() {\n  int t = 1;\n\
    \  // in(t);\n  while (t--) q();\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/8024\"\n\n#include \"\
  ...
  requiredBy: []
  timestamp: '2026-05-21 20:56:52+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verify/verify-yuki/yuki-8024.test.cpp
layout: document
redirect_from:
- /verify/verify/verify-yuki/yuki-8024.test.cpp
- /verify/verify/verify-yuki/yuki-8024.test.cpp.html
