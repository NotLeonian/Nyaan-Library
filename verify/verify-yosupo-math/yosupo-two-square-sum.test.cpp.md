...
data:
  ...
  bundledCode: "#line 1 \"verify/verify-yosupo-math/yosupo-two-square-sum.test.cpp\"\
    ...
    \ n numbers from [l, r) without overlapping\nvector<i64> randset(i64 l, i64 r,\
    \ i64 n) {\n  assert(l <= r && n <= r - l);\n  unordered_set<i64> s;\n  for (i64\
