...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"shortest-path/dijkstra-abstract.hpp\"\n\n#include <algorithm>\n\
    #include <functional>\n#include <map>\n#include <queue>\n#include <type_traits>\n\
    #include <utility>\n#include <vector>\nusing namespace std;\n\n// start : \u59CB\
...
documentation_of: shortest-path/dijkstra-abstract.hpp
layout: document
redirect_from:
- /library/shortest-path/dijkstra-abstract.hpp
- /library/shortest-path/dijkstra-abstract.hpp.html
