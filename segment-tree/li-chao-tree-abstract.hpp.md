...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 2 \"segment-tree/li-chao-tree-abstract.hpp\"\n\n#include <cassert>\n\
    #include <utility>\n#include <vector>\nusing namespace std;\n\n// Line : T operator(ll)\
...
layout: document
redirect_from:
- /library/segment-tree/li-chao-tree-abstract.hpp
- /library/segment-tree/li-chao-tree-abstract.hpp.html
